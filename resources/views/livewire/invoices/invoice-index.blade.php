            ...
            <tbody class="divide-y dark:divide-gray-700">
                @forelse($this->invoices as $invoice)
                        ...
                        default => 'bg-gray-200 text-gray-800',
                                    ...
                                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $invoice->issue_date->format('M d, Y') }}
                                    </td>
                                    <td class="px-6 py-3 text-gray-600 dark:text-gray-300">{{ $invoice->due_date->format('M d, Y') }}
                                    </td>
