                ...
                <div class="overflow-x-auto bg-white dark:bg-gray-800 rounded-lg shadow">
                    <table class="w-full text-sm">
                        <thead class="bg-gray-100 dark:bg-gray-700 border-b dark:border-gray-600">
                            <tr>
                                <th class="px-6 py-3 text-left font-semibold text-gray-900 dark:text-white">Invoice #
                                </th>
                                <th class="px-6 py-3 text-left font-semibold text-gray-900 dark:text-white">Status</th>
                                <th class="px-6 py-3 text-left font-semibold text-gray-900 dark:text-white">Issue Date
                                </th>
                                <th class="px-6 py-3 text-left font-semibold text-gray-900 dark:text-white">Due Date
                                </th>
                                <th class="px-6 py-3 text-right font-semibold text-gray-900 dark:text-white">Total</th>
                                <th class="px-6 py-3 text-center font-semibold text-gray-900 dark:text-white">Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody class="divide-y dark:divide-gray-700">
                            @forelse($this->invoices as $invoice)
                                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition">
                                                            <td class="px-6 py-3 font-mono text-gray-900 dark:text-white">
                                    ...
                                    default => 'bg-gray-200 text-gray-800',
                                                            ...
                                                            <td class="px-6 py-3 text-gray-600 dark:text-gray-300">
                                                                {{ $invoice->due_date->format('M d, Y') }}</td>
